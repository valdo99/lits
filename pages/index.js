    ...
    <div>
      ...
      <div className="mx-20">
        <button
          ...
          onClick={() => setShowModal({show: true, children:  <center>
            <h2 className="text-3xl text-center">Suggeriscici un brano!</h2>
            <p className="my-6 mx-12 text-[#a3aacf]">Noi del team Leets cerchiamo di aggiungere nuovi brani ogni giorno, ma non riusciamo a fare tutto da soli. Inserisci l'URL di un brano che vorresti vedere su Leets e potrai vedere il tuo artista crescere</p>
            <Input
              value={url}
